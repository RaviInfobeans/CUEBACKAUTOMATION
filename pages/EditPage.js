...
class EditPage{
    constructor(page){
        this.page = page
        this.EditPage = page.locator("//p[normalize-space()='Edit']")
    ...
    async CollectionCreate(){
        await expect.soft(this.EditPage).toBeVisible();                  //Validating Edit CTA is present.
        ...
        await expect.soft(this.createCollection).toBeVisible();             //Validating New collection CTA is present.
        await this.createCollection.click();                           //Clicking on New Collection CTA.
